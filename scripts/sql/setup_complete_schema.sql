...
CREATE TYPE IF NOT EXISTS appointment_type AS ENUM ('virtual', 'in-person');
CREATE TYPE IF NOT EXISTS appointment_status AS ENUM ('scheduled', 'completed', 'canceled', 'rescheduled');
...
CREATE TRIGGER IF NOT EXISTS update_patients_modtime
    BEFORE UPDATE ON patients
    FOR EACH ROW EXECUTE FUNCTION update_modified_column();

CREATE TRIGGER IF NOT EXISTS update_chat_sessions_modtime
    BEFORE UPDATE ON chat_sessions
    FOR EACH ROW EXECUTE FUNCTION update_modified_column();

CREATE TRIGGER IF NOT EXISTS update_knowledge_sources_modtime
    BEFORE UPDATE ON knowledge_sources
    FOR EACH ROW EXECUTE FUNCTION update_modified_column();

CREATE TRIGGER IF NOT EXISTS update_chat_strategies_modtime
    BEFORE UPDATE ON chat_strategies
    FOR EACH ROW EXECUTE FUNCTION update_modified_column();

CREATE TRIGGER IF NOT EXISTS update_extraction_rules_modtime
...
CREATE TRIGGER IF NOT EXISTS update_invites_modtime
    BEFORE UPDATE ON invites
    FOR EACH ROW EXECUTE FUNCTION update_modified_column();

CREATE TRIGGER IF NOT EXISTS update_risk_assessments_modtime
    BEFORE UPDATE ON risk_assessments
    FOR EACH ROW EXECUTE FUNCTION update_modified_column();

CREATE TRIGGER IF NOT EXISTS update_lab_orders_modtime
    BEFORE UPDATE ON lab_orders
    FOR EACH ROW EXECUTE FUNCTION update_modified_column();

CREATE TRIGGER IF NOT EXISTS update_lab_results_modtime
    BEFORE UPDATE ON lab_results
    FOR EACH ROW EXECUTE FUNCTION update_modified_column();

CREATE TRIGGER IF NOT EXISTS update_eligibility_results_modtime
    BEFORE UPDATE ON eligibility_results
    FOR EACH ROW EXECUTE FUNCTION update_modified_column();

CREATE TRIGGER IF NOT EXISTS update_appointments_modtime
    BEFORE UPDATE ON appointments
    FOR EACH ROW EXECUTE FUNCTION update_modified_column();

CREATE TRIGGER IF NOT EXISTS update_clinician_availability_modtime
