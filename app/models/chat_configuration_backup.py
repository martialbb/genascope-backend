...
class ChatStrategy(Base):
    ...
    # Simplified relationships for existing schema
...
class KnowledgeSource(Base):
    ...
    # chat_questions = relationship("ChatQuestion", back_populates="knowledge_source")  # Removed to avoid conflicts with old chat system
...
class StrategyExecution(Base):
    ...
    # session = relationship("AIChatSession", foreign_keys="AIChatSession.strategy_execution_id", back_populates="strategy_execution", uselist=False)  # Removed: AIChatSession doesn't have strategy_execution_id
